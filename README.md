...
| 268831 | arm64 | 静默防撤回、提示模式 | `Contents/Resources/wechat.dylib` |
...
- **自定义提示**：加 `--runtime-tip`。支持构建号 `268597`、`268599`、`268601`、`268602`，会安装
...
构建号 `268831` 目前只支持静默防撤回和提示模式，不支持
`--runtime-tip`、`--block-update` 或 `--multi-instance` 补丁。
